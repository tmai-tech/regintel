...
AUTHORITIES = [
    ...
    {"code": "GAC", "name": "General Authority for Competition (GAC)", "url": "https://gac.gov.sa", "country": "Saudi Arabia", "authority_type": "Authority", "label": "Saudi Arabia - GAC", "crawl_url": "https://gac.gov.sa"},
